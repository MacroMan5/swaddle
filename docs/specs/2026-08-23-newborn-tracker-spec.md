...
| FR-009 | L'historique MUST offrir sélecteur de journée, grille horaire 24 h où chaque événement est positionné et dimensionné selon son heure de début et sa durée réelle et s'ouvre au toucher, liste chronologique affichant heure de début ET heure de fin, filtres par catégorie et bascule jour/semaine. | P1 |
